...
function updateStudentGrade(studentsArray, idToUpdate, newGrade) {
  ...
  if (indexToUpdate !== -1) {
    ...
    // throw new Error("student with the provided ID is not found");
    console.log("student with the provided ID is not found");
